...
class mix:
    ...
    def class_image(self) -> np.ndarray:
        ...
        b = (
            a @ np.hstack((self.cell_link, self._spectral.cell_num + self.nar_link))
    ...
    def link(self) -> None:
        ...
        for annotation in ["cell", "nar"]:
            ...
            self._synthesize(
                annotation
            )  # generate a sp. mat. (annotation_v) linking spectra to annotation
    ...
    def _bin_overlap_gaussian(
        ...
        def gkern(length=5, sig=1.0):
            ...
            from https://stackoverflow.com/questions/29731726/
